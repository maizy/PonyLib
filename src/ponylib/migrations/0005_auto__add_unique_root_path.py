...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Root', fields ['path']
        db.create_unique('ponylib_root', ['path'])


    def backwards(self, orm):
        # Removing unique constraint on 'Root', fields ['path']
        db.delete_unique('ponylib_root', ['path'])
