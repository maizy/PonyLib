...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookSeries.number'
        db.alter_column(u'ponylib_book_series', 'number', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'BookSeries.number'
        db.alter_column(u'ponylib_book_series', 'number', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'ponylib.book': {
            ...
            'has_index_errors': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
