...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.has_index_errors'
        db.add_column('ponylib_book', 'has_index_errors',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.has_index_errors'
        db.delete_column('ponylib_book', 'has_index_errors')
