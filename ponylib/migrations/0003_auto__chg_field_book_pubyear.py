...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.pubyear'
        db.alter_column('ponylib_book', 'pubyear', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Book.pubyear'
        db.alter_column('ponylib_book', 'pubyear', self.gf('django.db.models.fields.IntegerField')(default=0))
